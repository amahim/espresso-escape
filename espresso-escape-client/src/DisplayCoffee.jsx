  ...
  return (
    <div>
      <div className="flex md:flex-row flex-col items-center gap-4 bg-[#F5F4F1] shadow-xl md:h-56 p-4 rounded-md">
        <div className="">
          <img src={photo} className="md:w-36" />
        </div>
        <div className="space-y-2 flex flex-col md:items-start items-center ">
          ...
          <div className="card-actions  ">
            <Link to={`coffee-details/${_id}`}>
              <button className="btn bg-[#D2B48C] border-none text-white text-xl">
                <FaEye />
              </button>
            </Link>
            <Link to={`update-coffee/${_id}`}>
              <button className="btn bg-[#3C393B] border-none text-white text-xl">
                <FaPen />
              </button>
            </Link>
            <button
